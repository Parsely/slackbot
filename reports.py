...
class ReportsHandler(object):
    ''' class to handle manually scheduled slack reports '''
    # current idea for UI, I think it's too unwieldy but:
    # reports, <meta>, <detail>, <timeframe>, <frequency>
    
    def sched_load():
        # load saved report to run
        pass
    
    def add_to_queue():
        # make timer object for report to run
        pass
